...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg shadow-green-600/40 ring-4 ring-green-500/20 transition-transform hover:scale-110 sm:bottom-8 sm:right-8"
    >
